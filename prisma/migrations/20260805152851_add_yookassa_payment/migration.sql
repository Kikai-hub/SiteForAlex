...
INSERT INTO "new_Order" ("accessToken", "addressApartment", "addressCity", "addressComment", "addressEntrance", "addressFloor", "addressHouse", "addressStreet", "assignedAt", "courierId", "createdAt", "customerId", "deliveredAt", "discountMinor", "fulfillmentType", "guestName", "guestPhone", "id", "notes", "paymentMethod", "promoCodeId", "promoCodeSnapshot", "status", "subtotalMinor", "totalMinor", "updatedAt") SELECT "accessToken", "addressApartment", "addressCity", "addressComment", "addressEntrance", "addressFloor", "addressHouse", "addressStreet", "assignedAt", "courierId", "createdAt", "customerId", "deliveredAt", "discountMinor", "fulfillmentType", "guestName", "guestPhone", "id", "notes", "paymentMethod", "promoCodeId", "promoCodeSnapshot", "status", "subtotalMinor", "totalMinor", "updatedAt" FROM "Order";
DROP TABLE "Order";
